...
3. **WebContainer Virtualization Engine Implementation**
   ...
   5. Preview URL: Add a listener for the WebContainer's server-ready event. Store the emitted URL in state and pass it to an iframe to act as the live preview window. Let's do Step 1 and 2 first. Show me the code for the Vite config and the initialization hook."
